...
public  class  montreal_server implements Interface {


    ConcurrentHashMap<String, ConcurrentHashMap<String, src.Details>> app;
    ...
    private static final int UDP_PORT2 = 50055;
    ...
    public montreal_server() throws SocketException {
        ...
        app.forEach((appointment_type, appointment_details_Map) -> {
            if (appointment_type.equals(t) && !appointment_details_Map.isEmpty()) {
                ...
                appointment_details_Map.forEach((appointmentID, appointmentDetails) ->
                        Map.get("MTL").put(appointmentID, appointmentDetails.get_capacity()));
        ...
        try (DatagramSocket socket = new DatagramSocket()) {
            ...
            while (true)    {
                ...
                synchronized (Map) {
                    ...
                    Map.get("QUE").put(appointment_id, capacity);
                }
            }
        } catch (IOException e) {
            throw new RuntimeException(e);
    ...
    private String Availabilty(String[] parts) {
        ...
        return Availability_In_MTL2(patientID, oldAppointmentID, oldAppointmentType, newAppointmentID, newAppointmentType);
    }
    ...
    private String Book(String[] parts)
    {
        ...
        return Book_In_MTL2(patientID,newAppointmentType, newAppointmentID);
    }
    ...
    private String cancel(String[] parts)
    {
        ...
        return cancel_In_MTL2(patientID,oldAppointmentType, oldAppointmentID);
    }
